<?php get_header(); ?>
        ...
        <div class="bg-[#ff7a21] flex-1 p-12 lg:p-20 flex flex-col md:flex-row items-center relative overflow-hidden">
            ...
            <div class="md:w-1/2 relative z-10 text-white space-y-6">
                <div class="inline-block bg-white text-black rounded-full px-3 py-1 text-sm font-bold flex items-center w-max shadow-sm">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/dog_cat.png" class="w-6 h-6 rounded-full mr-2 object-cover" alt="icon">
            ...
            <div class="md:w-1/2 relative mt-10 md:mt-0 flex justify-center">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/dog_cat.png" alt="Dog and Cat" class="relative z-10 w-full max-h-[500px] object-contain drop-shadow-2xl">
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-8 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-[#52a6ce] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-white">
                        ...
                        <div class="text-xs opacity-80">12 Sản Phẩm</div>
                    </div>
                </div>
                <div class="bg-white text-gray-800 rounded-full w-8 h-8 flex items-center justify-center font-bold shadow-md">›</div>
            </div>
            
            <div class="bg-[#dca449] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
            ...
            <div class="bg-[#1b2b22] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-white">
                        ...
                        <div class="text-xs opacity-80">20 Sản Phẩm</div>
                    </div>
                </div>
                <div class="bg-white text-gray-800 rounded-full w-8 h-8 flex items-center justify-center font-bold shadow-md">›</div>
            </div>

            <div class="bg-[#c6364a] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-white">
                        ...
                        <div class="text-xs opacity-80">1 Sản Phẩm</div>
                    </div>
                </div>
                <div class="bg-white text-gray-800 rounded-full w-8 h-8 flex items-center justify-center font-bold shadow-md">›</div>
            </div>

            <div class="bg-[#4b553d] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
            ...
            <div class="bg-[#9f85ff] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
            ...
            <div class="bg-[#d2b897] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
            ...
            <div class="bg-[#e4aeba] rounded-full p-2 pr-6 flex items-center justify-between hover:-translate-y-1 transition duration-300 cursor-pointer shadow-sm">
                <div class="flex items-center">
                ...
                while ($loop->have_posts()) : $loop->the_post();
                    ...
                    <div class="h-48 relative flex justify-center items-center mb-4">
                        <a href="<?php the_permalink(); ?>" class="w-full h-full flex justify-center items-center">
                            <?php the_post_thumbnail('medium', ['class' => 'max-h-full object-contain group-hover:scale-105 transition-transform duration-300']); ?>
                        </a>
    ...
    <section class="max-w-7xl mx-auto px-8 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            ...
            if ( $news_query->have_posts() ) : while ( $news_query->have_posts() ) : $news_query->the_post(); ?>
                ...
                <div class="group p-8 rounded-[40px] transition-all duration-300 hover:bg-white hover:shadow-2xl hover:shadow-gray-200/50 cursor-pointer">
                    <div class="relative mb-8">
                        <div class="bg-gray-200 w-full h-56 blob-shape mx-auto shadow-inner overflow-hidden">
                            <?php if ( has_post_thumbnail() ) : 
                                the_post_thumbnail('large', ['class' => 'w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500']); 
                            else : ?>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/placeholder-icon.png" class="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500">
                            <?php endif; ?>
                        </div>
